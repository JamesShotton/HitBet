...
const LIVE_ARBS = [
  { event: "Arsenal vs Chelsea", sport: "EPL", margin: "3.42%", profit: "£1.71", book1: "Bet365", book2: "Unibet", time: "in 45m" },
  { event: "Lakers vs Celtics", sport: "NBA", margin: "2.88%", profit: "£1.44", book1: "William Hill", book2: "Betway", time: "in 2h" },
  { event: "Djokovic vs Alcaraz", sport: "ATP", margin: "2.11%", profit: "£1.06", book1: "Paddy Power", book2: "Betfair", time: "in 3h" },
  { event: "Man City vs Liverpool", sport: "EPL", margin: "1.74%", profit: "£0.87", book1: "888sport", book2: "Coral", time: "tomorrow" },
  { event: "Sinner vs Zverev", sport: "ATP", margin: "1.31%", profit: "£0.66", book1: "Ladbrokes", book2: "Betfair", time: "tomorrow" },
  { event: "Real Madrid vs Barca", sport: "La Liga", margin: "2.55%", profit: "£1.28", book1: "Bet365", book2: "Betfair", time: "in 6h" },
];
      ...
      <div style={{ ...t.tickerTrack, transform: `translateX(${x}px)` }}>
        {items.map((a, i) => (
          <div key={i} style={t.tickerCard}>
            ...
            <div style={t.tickerBooks}>{a.book1} · {a.book2}</div>
          </div>
        ))}
      </div>
    ...
    <div style={t.root}>
      ...
      <section style={t.hero}>
        <div style={t.heroInner}>
          ...
          <h1 style={t.h1}>
            The books made<br />
            a <span style={t.grad}>pricing mistake.</span><br />
            We found it.
          </h1>

          <p style={t.heroSub}>
            HitBet scans 40+ sportsbooks in real time, detects true arbitrage, and hands you a clean stake split to execute immediately. No prediction. No luck. Pure maths.
          </p>
          ...
          <div style={t.heroNote}>Card required · £0 charged today · Cancel anytime</div>
        </div>

        {/* Live arb card floating right */}
        ...
        <div style={t.sectionInner}>
          <div style={t.sectionHead}>
            ...
            <p style={t.sectionSub}>
              We handle the scanning and maths. You handle the execution. That's the whole system.
            </p>
          </div>
        ...
        <div style={t.sectionInner}>
          <div style={t.exampleGrid}>
            <div>
              ...
              <h2 style={t.h2}>Everything you need.<br />Nothing you don't.</h2>
              <p style={t.sectionSub}>
                Every arb surfaces as a single execution card. Who to back, where, how much. Place both legs within a minute and move on.
              </p>
              <div style={t.checkList}>
                {["Exact stake split calculated", "Both books named", "Market & settlement matched", "Margin and guaranteed profit shown"].map(c => (
              ...
              <Link href="/pricing" style={{ ...t.btnPrimary, marginTop: 28, display: "inline-flex" }}>
                Start 7-day trial
              </Link>
            </div>
      ...
      <section style={t.section}>
        <div style={t.sectionInner}>
          <div style={t.sectionHead}>
            ...
            <p style={t.sectionSub}>7-day free trial on both plans. Card required — cancels automatically if you don't continue.</p>
          </div>

          <div style={t.plansGrid}>
            <div style={t.planCard}>
              <div style={t.planName}>Pro</div>
              <div style={t.planPrice}>£39.99<span style={t.planPer}>/mo</span></div>
              <div style={t.planHr} />
              <ul style={t.planList}>
                {["Full 2-outcome arb feed", "Stake splits included", "30s refresh", "Suspicious edge flags"].map(f => (
                  <li key={f} style={t.planItem}><span style={t.planCheck}>✓</span>{f}</li>
                ))}
              </ul>
              <Link href="/checkout?plan=pro&trial=true" style={t.btnPrimary}>Try free — 7 days</Link>
            ...
            <div style={{ ...t.planCard, ...t.planCardElite }}>
              ...
              <div style={t.planPrice}>£59.99<span style={t.planPer}>/mo</span></div>
              <div style={t.planHr} />
              <div style={t.planEverything}>Everything in Pro, plus:</div>
              <ul style={t.planList}>
                {["3-way markets (football 1X2)", "Value watchlist", "Telegram alerts", "Priority support"].map(f => (
                  <li key={f} style={t.planItem}><span style={t.planCheck}>✓</span>{f}</li>
                ))}
              </ul>
              <Link href="/checkout?plan=elite&trial=true" style={t.btnPrimary}>Try free — 7 days</Link>
      ...
      <section style={t.footerCta}>
        <div style={t.footerCtaInner}>
          <h2 style={{ ...t.h2, textAlign: "center" }}>The maths doesn't lie.</h2>
          <p style={{ ...t.sectionSub, textAlign: "center", maxWidth: 540, margin: "12px auto 28px" }}>
            Every arb on HitBet is a real pricing inefficiency. Place both legs correctly and the profit is guaranteed by maths alone.
          </p>
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/pricing" style={t.btnPrimary}>Start 7-day free trial</Link>
            <Link href="/dashboard" style={t.btnGhost}>View the feed</Link>
          </div>
        </div>
      </section>
...
const t: Record<string, React.CSSProperties> = {
  ...
  heroCtas: { display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" },
  ...
  heroCardEvent: { fontSize: 20, fontWeight: 800, color: "white", marginBottom: 6 },
  heroCardMeta: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 },
  ...
  heroCardHr: { height: 1, background: "rgba(255,255,255,0.08)", margin: "0 0 14px" },
  heroCardLegs: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 14 },
  heroLeg: {
  ...
  tickerEvent: { fontSize: 13, fontWeight: 700, color: "white", marginBottom: 6, whiteSpace: "nowrap" },
  tickerMeta: { display: "flex", gap: 10, alignItems: "center", marginBottom: 4 },
  ...
  statVal: { fontSize: 30, fontWeight: 900, letterSpacing: "-1px", color: "white", marginBottom: 4 },
  ...
  h2: { fontSize: 40, fontWeight: 900, letterSpacing: "-1px", color: "white", margin: "0 0 14px", lineHeight: 1.1 },
  sectionSub: { fontSize: 16, color: "rgba(255,255,255,0.6)", lineHeight: 1.75, margin: 0 },

  // How it works
  howGrid: { display: "grid", gridTemplateColumns: "repeat(3, minmax(0,1fr))", gap: 16 },
  howCard: {
    border: "1px solid rgba(255,255,255,0.08)",
    background: "rgba(255,255,255,0.03)",
    borderRadius: 20,
  ...
  checkItem: { display: "flex", gap: 10, fontSize: 15, color: "rgba(255,255,255,0.8)", alignItems: "center" },
  ...
  exCardTop: { display: "flex", justifyContent: "space-between", gap: 12, marginBottom: 16, flexWrap: "wrap" },
  ...
  exMetricLabel: { fontSize: 11, color: "rgba(255,255,255,0.5)", marginBottom: 4 },
  exMetricVal: { fontSize: 18, fontWeight: 800, color: "white" },
  exLegs: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 },
  exLeg: {
    border: "1px solid rgba(255,255,255,0.08)",
    background: "rgba(255,255,255,0.03)",
    borderRadius: 16,
  ...
  exLegOdds: { fontSize: 13, fontWeight: 700, color: "#98b8ff", marginBottom: 6 },
  ...
  // Plans
  plansGrid: { display: "grid", gridTemplateColumns: "repeat(2, minmax(0,1fr))", gap: 18 },
  planCard: {
    position: "relative",
  ...
  planName: { fontSize: 16, fontWeight: 800, color: "rgba(255,255,255,0.7)", marginBottom: 8 },
  planPrice: { fontSize: 46, fontWeight: 900, letterSpacing: "-1px", color: "white", lineHeight: 1 },
  ...
  planEverything: { fontSize: 12, color: "rgba(255,255,255,0.45)", marginBottom: 10 },
  planList: { listStyle: "none", margin: "0 0 22px", padding: 0, display: "grid", gap: 10 },
  planItem: { display: "flex", gap: 10, fontSize: 14, color: "rgba(255,255,255,0.85)", alignItems: "center" },
